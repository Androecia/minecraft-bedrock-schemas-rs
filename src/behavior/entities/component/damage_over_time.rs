/* Raw contents of damage_over_time.json That I want to use to make a rust Struct from this Json Schema:
{
  "$id": "blockception.minecraft.behavior.entities.minecraft.damage_over_time",
  "type": "object",
