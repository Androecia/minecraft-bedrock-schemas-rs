/* Raw contents of go_and_give_items_to_noteblock.json That I want to use to make a rust Struct from this Json Schema:
{
...
pub struct GoAndGiveItemsToNoteblock {}
