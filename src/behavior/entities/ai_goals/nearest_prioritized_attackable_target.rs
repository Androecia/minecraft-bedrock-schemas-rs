/* Raw contents of nearest_prioritized_attackable_target.json That I want to use to make a rust Struct from this Json Schema:
{
...
pub struct NearestPrioritizedAttackableTarget {}
